...
mkdir whe
cd ~/wh
git clone https://kotaro_sakamoto@bitbucket.org/kotaro_sakamoto/worldhistoryindriindex.git
...
rm -rf .git/
cd ~/whe
git clone https://kotaro_sakamoto@bitbucket.org/kotaro_sakamoto/worldhistoryindriindex-englishversion.git
