package us.feliscat.reconstructor.unit

import us.feliscat.text.analyzer.dep.Chunk
import us.feliscat.text.analyzer.dep.chapas.{PAS, Token}
import us.feliscat.util.Color
