...
object DamerauLevenshteinDistance extends DamerauLevenshteinDistance(
  LibrariesConfig.damerauLevenshteinDeleteCost,
  LibrariesConfig.damerauLevenshteinInsertCost,
  LibrariesConfig.damerauLevenshteinReplaceCost,
  LibrariesConfig.damerauLevenshteinSwapCost)
