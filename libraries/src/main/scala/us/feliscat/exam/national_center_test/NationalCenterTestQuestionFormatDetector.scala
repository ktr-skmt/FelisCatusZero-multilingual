package us.feliscat.exam.national_center_test

import us.feliscat.exam.national_center_test.xml.SmallQuestion
import us.feliscat.exam.national_center_test.xml.choice._
import us.feliscat.exam.{Question, QuestionFormat, QuestionFormatDetector}
