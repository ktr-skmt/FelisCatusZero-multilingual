...
import us.feliscat.exam.national_center_test.NationalCenterTestQuestionFormatDetector
import us.feliscat.exam.national_center_test.xml.choice.ChoicesImpl
import us.feliscat.exam.{Question, QuestionFormat}
 ...
 * </pre>
 * @param id id
 * @param question uima.modules.qa.question xml
