...
import us.feliscat.text.analyzer.dep.chapas.Doc
...
trait Cache {
  ...
  private var docsCache = Option.empty[Map[String, Doc]]
  ...
  def getDocCache(normalizedString: JapaneseNormalizedString): Option[Doc] = {
