...
public class Score_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Score");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "us.feliscat.types.Score");
  ...
  public String getScorer(int addr) {
      ...
      jcas.throwFeatMissing("scorer", "us.feliscat.types.Score");
