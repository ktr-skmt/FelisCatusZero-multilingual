...
import us.feliscat.types.ja.KNP;
import us.feliscat.types.ja.ChaPAS;
  ...
  */  
  ...
  public FSList getPassageSet() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_passageSet == null)
      jcasType.jcas.throwFeatMissing("passageSet", "us.feliscat.types.Sentence");
  ...
  public FSList getDocumentSet() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_documentSet == null)
      jcasType.jcas.throwFeatMissing("documentSet", "us.feliscat.types.Sentence");
  ...
  public String getOriginalText() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_originalText == null)
      jcasType.jcas.throwFeatMissing("originalText", "us.feliscat.types.Sentence");
  ...
  public FSList getMorphemeAnalysisList() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_morphemeAnalysisList == null)
      jcasType.jcas.throwFeatMissing("morphemeAnalysisList", "us.feliscat.types.Sentence");
  ...
  //*--------------*
  //* Feature: coreNLPAnalysisList

  /** getter for coreNLPAnalysisList - gets CoreNLP Analysis List
   * @generated
   * @return value of the feature 
   */
  public FSList getCoreNLPAnalysisList() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_coreNLPAnalysisList == null)
      jcasType.jcas.throwFeatMissing("coreNLPAnalysisList", "us.feliscat.types.Sentence");
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Sentence_Type)jcasType).casFeatCode_coreNLPAnalysisList)));}
    
  /** setter for coreNLPAnalysisList - sets CoreNLP Analysis List 
   * @generated
   * @param v value to set into the feature 
   */
  public void setCoreNLPAnalysisList(FSList v) {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_coreNLPAnalysisList == null)
      jcasType.jcas.throwFeatMissing("coreNLPAnalysisList", "us.feliscat.types.Sentence");
    jcasType.ll_cas.ll_setRefValue(addr, ((Sentence_Type)jcasType).casFeatCode_coreNLPAnalysisList, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public FSList getCabochaAnalysisList() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_cabochaAnalysisList == null)
      jcasType.jcas.throwFeatMissing("cabochaAnalysisList", "us.feliscat.types.Sentence");
  ...
  public ChaPAS getIpadicChapas() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_ipadicChapas == null)
      jcasType.jcas.throwFeatMissing("ipadicChapas", "us.feliscat.types.Sentence");
  ...
  public KNP getKnp() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_knp == null)
      jcasType.jcas.throwFeatMissing("knp", "us.feliscat.types.Sentence");
  ...
  public FSList getPasList() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_pasList == null)
      jcasType.jcas.throwFeatMissing("pasList", "us.feliscat.types.Sentence");
  ...
  public FSList getCandidateSentenceList() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_candidateSentenceList == null)
      jcasType.jcas.throwFeatMissing("candidateSentenceList", "us.feliscat.types.Sentence");
  ...
  public boolean getContainsQuery() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_containsQuery == null)
      jcasType.jcas.throwFeatMissing("containsQuery", "us.feliscat.types.Sentence");
