...
public class KeywordQuery_Type extends Query_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.KeywordQuery");
  ...
  public int getKeyword(int addr) {
      ...
      jcas.throwFeatMissing("keyword", "us.feliscat.types.KeywordQuery");
  ...
  public KeywordQuery_Type(JCas jcas, Type casType) {
    ...
    casFeat_keyword = jcas.getRequiredFeatureDE(casType, "keyword", "us.feliscat.types.Keyword", featOkTst);
