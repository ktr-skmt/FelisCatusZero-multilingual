...
public class TextAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.TextAnnotation");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "us.feliscat.types.TextAnnotation");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "us.feliscat.types.TextAnnotation");
  ...
  public String getDocno(int addr) {
      ...
      jcas.throwFeatMissing("docno", "us.feliscat.types.TextAnnotation");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("title", "us.feliscat.types.TextAnnotation");
  ...
  public int getScoreList(int addr) {
      ...
      jcas.throwFeatMissing("scoreList", "us.feliscat.types.TextAnnotation");
  ...
  public int getMorphemeList(int addr) {
      ...
      jcas.throwFeatMissing("morphemeList", "us.feliscat.types.TextAnnotation");
  ...
  public int getContentWordList(int addr) {
      ...
      jcas.throwFeatMissing("contentWordList", "us.feliscat.types.TextAnnotation");
  ...
  public int getBeginTime(int addr) {
      ...
      jcas.throwFeatMissing("beginTime", "us.feliscat.types.TextAnnotation");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "us.feliscat.types.TextAnnotation");
  ...
  public int getGeography(int addr) {
      ...
      jcas.throwFeatMissing("geography", "us.feliscat.types.TextAnnotation");
  ...
  public int getSemanticTypeList(int addr) {
      ...
      jcas.throwFeatMissing("semanticTypeList", "us.feliscat.types.TextAnnotation");
  ...
  public TextAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeat_beginTime = jcas.getRequiredFeatureDE(casType, "beginTime", "us.feliscat.types.Time", featOkTst);
    casFeatCode_beginTime  = (null == casFeat_beginTime) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_beginTime).getCode();

 
    casFeat_endTime = jcas.getRequiredFeatureDE(casType, "endTime", "us.feliscat.types.Time", featOkTst);
    casFeatCode_endTime  = (null == casFeat_endTime) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_endTime).getCode();

 
    casFeat_geography = jcas.getRequiredFeatureDE(casType, "geography", "us.feliscat.types.Geography", featOkTst);
