...
public class Time_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Time");
  ...
  public int getTextList(int addr) {
      ...
      jcas.throwFeatMissing("textList", "us.feliscat.types.Time");
  ...
  public int getYear(int addr) {
      ...
      jcas.throwFeatMissing("year", "us.feliscat.types.Time");
