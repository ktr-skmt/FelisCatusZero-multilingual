 ...
 * @generated */
public class PartOfSpeech_Type extends TOP_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.PartOfSpeech");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "us.feliscat.types.PartOfSpeech");
