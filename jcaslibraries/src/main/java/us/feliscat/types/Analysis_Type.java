...
public class Analysis_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Analysis");
  ...
  public String getAnalysisResult(int addr) {
      ...
      jcas.throwFeatMissing("analysisResult", "us.feliscat.types.Analysis");
