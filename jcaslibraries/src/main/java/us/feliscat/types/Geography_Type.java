...
public class Geography_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Geography");
  ...
  public int getTermList(int addr) {
      ...
      jcas.throwFeatMissing("termList", "us.feliscat.types.Geography");
  ...
  public int getArea(int addr) {
      ...
      jcas.throwFeatMissing("area", "us.feliscat.types.Geography");
