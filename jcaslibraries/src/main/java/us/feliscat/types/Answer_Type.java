...
public class Answer_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Answer");
  ...
  public int getDocument(int addr) {
      ...
      jcas.throwFeatMissing("document", "us.feliscat.types.Answer");
  ...
  public boolean getIsGoldStandard(int addr) {
      ...
      jcas.throwFeatMissing("isGoldStandard", "us.feliscat.types.Answer");
  ...
  public String getWriter(int addr) {
      ...
      jcas.throwFeatMissing("writer", "us.feliscat.types.Answer");
