...
public class Passage_Type extends TextAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Passage");
  ...
  public int getDocumentSet(int addr) {
      ...
      jcas.throwFeatMissing("documentSet", "us.feliscat.types.Passage");
  ...
  public int getSentenceSet(int addr) {
      ...
      jcas.throwFeatMissing("sentenceSet", "us.feliscat.types.Passage");
  ...
  public boolean getContainsQuery(int addr) {
      ...
      jcas.throwFeatMissing("containsQuery", "us.feliscat.types.Passage");
