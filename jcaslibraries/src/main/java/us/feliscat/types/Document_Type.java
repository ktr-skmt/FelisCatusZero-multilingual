...
public class Document_Type extends TextAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Document");
  ...
  public int getPassageSet(int addr) {
      ...
      jcas.throwFeatMissing("passageSet", "us.feliscat.types.Document");
  ...
  public int getSentenceSet(int addr) {
      ...
      jcas.throwFeatMissing("sentenceSet", "us.feliscat.types.Document");
