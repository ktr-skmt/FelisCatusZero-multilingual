...
import us.feliscat.types.Analysis_Type;
...
public class Morpheme_Type extends Analysis_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.Morpheme");
  ...
  public String getOriginalText(int addr) {
      ...
      jcas.throwFeatMissing("originalText", "us.feliscat.types.ja.Morpheme");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "us.feliscat.types.ja.Morpheme");
  ...
  public String getPos(int addr) {
      ...
      jcas.throwFeatMissing("pos", "us.feliscat.types.ja.Morpheme");
  ...
  public int getWordEmbeddingList(int addr) {
      ...
      jcas.throwFeatMissing("wordEmbeddingList", "us.feliscat.types.ja.Morpheme");
  ...
  public int getSemanticType(int addr) {
      ...
      jcas.throwFeatMissing("semanticType", "us.feliscat.types.ja.Morpheme");
  ...
  public boolean getIsTerm(int addr) {
      ...
      jcas.throwFeatMissing("isTerm", "us.feliscat.types.ja.Morpheme");
  ...
  public Morpheme_Type(JCas jcas, Type casType) {
    ...
    casFeat_semanticType = jcas.getRequiredFeatureDE(casType, "semanticType", "us.feliscat.types.ja.SemanticType", featOkTst);
