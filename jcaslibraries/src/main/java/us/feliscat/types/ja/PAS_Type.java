...
public class PAS_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.PAS");
  ...
  public int getPredicate(int addr) {
      ...
      jcas.throwFeatMissing("predicate", "us.feliscat.types.ja.PAS");
  ...
  public int getCaseList(int addr) {
      ...
      jcas.throwFeatMissing("caseList", "us.feliscat.types.ja.PAS");
  ...
  public PAS_Type(JCas jcas, Type casType) {
    ...
    casFeat_predicate = jcas.getRequiredFeatureDE(casType, "predicate", "us.feliscat.types.ja.Bunsetsu", featOkTst);
