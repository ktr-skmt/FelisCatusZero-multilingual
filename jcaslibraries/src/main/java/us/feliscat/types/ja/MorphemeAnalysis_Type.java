...
public class MorphemeAnalysis_Type extends Analysis_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.MorphemeAnalysis");
  ...
  public String getAnalyzer(int addr) {
      ...
      jcas.throwFeatMissing("analyzer", "us.feliscat.types.ja.MorphemeAnalysis");
  ...
  public int getMorphemeList(int addr) {
      ...
      jcas.throwFeatMissing("morphemeList", "us.feliscat.types.ja.MorphemeAnalysis");
