...
public class SemanticType_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.SemanticType");
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "us.feliscat.types.ja.SemanticType");
  ...
  public int getTypeList(int addr) {
      ...
      jcas.throwFeatMissing("typeList", "us.feliscat.types.ja.SemanticType");
