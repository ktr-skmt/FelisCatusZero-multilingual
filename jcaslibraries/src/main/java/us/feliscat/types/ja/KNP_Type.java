...
public class KNP_Type extends DependencyAnalysis_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.KNP");
  ...
  public String getAnalysisResultCase(int addr) {
      ...
      jcas.throwFeatMissing("analysisResultCase", "us.feliscat.types.ja.KNP");
  ...
  public String getAnalysisResultReference(int addr) {
      ...
      jcas.throwFeatMissing("analysisResultReference", "us.feliscat.types.ja.KNP");
