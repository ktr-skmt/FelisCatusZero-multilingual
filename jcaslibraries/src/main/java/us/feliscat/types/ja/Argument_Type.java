...
public class Argument_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.Argument");
  ...
  public String getCase(int addr) {
      ...
      jcas.throwFeatMissing("case", "us.feliscat.types.ja.Argument");
  ...
  public int getBunsetsu(int addr) {
      ...
      jcas.throwFeatMissing("bunsetsu", "us.feliscat.types.ja.Argument");
  ...
  public Argument_Type(JCas jcas, Type casType) {
    ...
    casFeat_bunsetsu = jcas.getRequiredFeatureDE(casType, "bunsetsu", "us.feliscat.types.ja.Bunsetsu", featOkTst);
