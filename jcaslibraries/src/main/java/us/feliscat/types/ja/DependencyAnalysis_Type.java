...
public class DependencyAnalysis_Type extends Analysis_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.ja.DependencyAnalysis");
  ...
  public String getAnalysisResultTreeFormat(int addr) {
      ...
      jcas.throwFeatMissing("analysisResultTreeFormat", "us.feliscat.types.ja.DependencyAnalysis");
  ...
  public int getBunsetsuList(int addr) {
      ...
      jcas.throwFeatMissing("bunsetsuList", "us.feliscat.types.ja.DependencyAnalysis");
