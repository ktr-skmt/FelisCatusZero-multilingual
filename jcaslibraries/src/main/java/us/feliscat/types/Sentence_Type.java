...
public class Sentence_Type extends TextAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Sentence");
  ...
  public int getPassageSet(int addr) {
      ...
      jcas.throwFeatMissing("passageSet", "us.feliscat.types.Sentence");
  ...
  public int getDocumentSet(int addr) {
      ...
      jcas.throwFeatMissing("documentSet", "us.feliscat.types.Sentence");
  ...
  public String getOriginalText(int addr) {
      ...
      jcas.throwFeatMissing("originalText", "us.feliscat.types.Sentence");
  ...
  public int getMorphemeAnalysisList(int addr) {
      ...
      jcas.throwFeatMissing("morphemeAnalysisList", "us.feliscat.types.Sentence");
  ...
  /** @generated */
  final Feature casFeat_coreNLPAnalysisList;
  /** @generated */
  final int     casFeatCode_coreNLPAnalysisList;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public int getCoreNLPAnalysisList(int addr) {
        if (featOkTst && casFeat_coreNLPAnalysisList == null)
      jcas.throwFeatMissing("coreNLPAnalysisList", "us.feliscat.types.Sentence");
    return ll_cas.ll_getRefValue(addr, casFeatCode_coreNLPAnalysisList);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setCoreNLPAnalysisList(int addr, int v) {
        if (featOkTst && casFeat_coreNLPAnalysisList == null)
      jcas.throwFeatMissing("coreNLPAnalysisList", "us.feliscat.types.Sentence");
    ll_cas.ll_setRefValue(addr, casFeatCode_coreNLPAnalysisList, v);}
  ...
  public int getCabochaAnalysisList(int addr) {
      ...
      jcas.throwFeatMissing("cabochaAnalysisList", "us.feliscat.types.Sentence");
  ...
  public int getIpadicChapas(int addr) {
      ...
      jcas.throwFeatMissing("ipadicChapas", "us.feliscat.types.Sentence");
  ...
  public int getKnp(int addr) {
      ...
      jcas.throwFeatMissing("knp", "us.feliscat.types.Sentence");
  ...
  public int getPasList(int addr) {
      ...
      jcas.throwFeatMissing("pasList", "us.feliscat.types.Sentence");
  ...
  public int getCandidateSentenceList(int addr) {
      ...
      jcas.throwFeatMissing("candidateSentenceList", "us.feliscat.types.Sentence");
  ...
  public boolean getContainsQuery(int addr) {
      ...
      jcas.throwFeatMissing("containsQuery", "us.feliscat.types.Sentence");
  ...
  public Sentence_Type(JCas jcas, Type casType) {
    ...
    casFeat_coreNLPAnalysisList = jcas.getRequiredFeatureDE(casType, "coreNLPAnalysisList", "uima.cas.FSList", featOkTst);
    casFeatCode_coreNLPAnalysisList  = (null == casFeat_coreNLPAnalysisList) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_coreNLPAnalysisList).getCode();
    ...
    casFeat_ipadicChapas = jcas.getRequiredFeatureDE(casType, "ipadicChapas", "us.feliscat.types.ja.ChaPAS", featOkTst);
    casFeatCode_ipadicChapas  = (null == casFeat_ipadicChapas) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_ipadicChapas).getCode();

 
    casFeat_knp = jcas.getRequiredFeatureDE(casType, "knp", "us.feliscat.types.ja.KNP", featOkTst);
