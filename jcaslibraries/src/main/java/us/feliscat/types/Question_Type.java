...
public class Question_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Question");
 
  /** @generated */
  final Feature casFeat_exam;
  /** @generated */
  final int     casFeatCode_exam;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public int getExam(int addr) {
        if (featOkTst && casFeat_exam == null)
      jcas.throwFeatMissing("exam", "us.feliscat.types.Question");
    return ll_cas.ll_getRefValue(addr, casFeatCode_exam);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setExam(int addr, int v) {
        if (featOkTst && casFeat_exam == null)
      jcas.throwFeatMissing("exam", "us.feliscat.types.Question");
    ll_cas.ll_setRefValue(addr, casFeatCode_exam, v);}
  ...
  public String getXml(int addr) {
      ...
      jcas.throwFeatMissing("xml", "us.feliscat.types.Question");
  ...
  public int getDocument(int addr) {
      ...
      jcas.throwFeatMissing("document", "us.feliscat.types.Question");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "us.feliscat.types.Question");
  ...
  public String getQuestionFormatType(int addr) {
      ...
      jcas.throwFeatMissing("questionFormatType", "us.feliscat.types.Question");
  ...
  public String getAnswerFormatType(int addr) {
      ...
      jcas.throwFeatMissing("answerFormatType", "us.feliscat.types.Question");
  ...
  public int getQuerySet(int addr) {
      ...
      jcas.throwFeatMissing("querySet", "us.feliscat.types.Question");
  ...
  public int getKeywordSet(int addr) {
      ...
      jcas.throwFeatMissing("keywordSet", "us.feliscat.types.Question");
  ...
  /** @generated */
  final Feature casFeat_beginLengthLimit;
  /** @generated */
  final int     casFeatCode_beginLengthLimit;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public int getBeginLengthLimit(int addr) {
        if (featOkTst && casFeat_beginLengthLimit == null)
      jcas.throwFeatMissing("beginLengthLimit", "us.feliscat.types.Question");
    return ll_cas.ll_getIntValue(addr, casFeatCode_beginLengthLimit);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setBeginLengthLimit(int addr, int v) {
        if (featOkTst && casFeat_beginLengthLimit == null)
      jcas.throwFeatMissing("beginLengthLimit", "us.feliscat.types.Question");
    ll_cas.ll_setIntValue(addr, casFeatCode_beginLengthLimit, v);}
    
  
 
  /** @generated */
  final Feature casFeat_endLengthLimit;
  /** @generated */
  final int     casFeatCode_endLengthLimit;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public int getEndLengthLimit(int addr) {
        if (featOkTst && casFeat_endLengthLimit == null)
      jcas.throwFeatMissing("endLengthLimit", "us.feliscat.types.Question");
    return ll_cas.ll_getIntValue(addr, casFeatCode_endLengthLimit);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setEndLengthLimit(int addr, int v) {
        if (featOkTst && casFeat_endLengthLimit == null)
      jcas.throwFeatMissing("endLengthLimit", "us.feliscat.types.Question");
    ll_cas.ll_setIntValue(addr, casFeatCode_endLengthLimit, v);}
  ...
  public int getBeginTimeLimit(int addr) {
      ...
      jcas.throwFeatMissing("beginTimeLimit", "us.feliscat.types.Question");
  ...
  public int getEndTimeLimit(int addr) {
      ...
      jcas.throwFeatMissing("endTimeLimit", "us.feliscat.types.Question");
  ...
  public int getGeographyLimit(int addr) {
      ...
      jcas.throwFeatMissing("geographyLimit", "us.feliscat.types.Question");
  ...
  public int getQuestionFocusSet(int addr) {
      ...
      jcas.throwFeatMissing("questionFocusSet", "us.feliscat.types.Question");
  ...
  public int getLexicalAnswerTypeSet(int addr) {
      ...
      jcas.throwFeatMissing("lexicalAnswerTypeSet", "us.feliscat.types.Question");
  ...
  public int getSemanticAnswerTypeSet(int addr) {
      ...
      jcas.throwFeatMissing("semanticAnswerTypeSet", "us.feliscat.types.Question");
  ...
  public int getAnswerSet(int addr) {
      ...
      jcas.throwFeatMissing("answerSet", "us.feliscat.types.Question");
  ...
  public Question_Type(JCas jcas, Type casType) {
    ...
    casFeat_exam = jcas.getRequiredFeatureDE(casType, "exam", "us.feliscat.types.Exam", featOkTst);
    casFeatCode_exam  = (null == casFeat_exam) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_exam).getCode();
    ...
    casFeat_document = jcas.getRequiredFeatureDE(casType, "document", "us.feliscat.types.Document", featOkTst);
    ...
    casFeat_beginLengthLimit = jcas.getRequiredFeatureDE(casType, "beginLengthLimit", "uima.cas.Integer", featOkTst);
    casFeatCode_beginLengthLimit  = (null == casFeat_beginLengthLimit) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_beginLengthLimit).getCode();

 
    casFeat_endLengthLimit = jcas.getRequiredFeatureDE(casType, "endLengthLimit", "uima.cas.Integer", featOkTst);
    casFeatCode_endLengthLimit  = (null == casFeat_endLengthLimit) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_endLengthLimit).getCode();

 
    casFeat_beginTimeLimit = jcas.getRequiredFeatureDE(casType, "beginTimeLimit", "us.feliscat.types.Time", featOkTst);
    ...
    casFeat_endTimeLimit = jcas.getRequiredFeatureDE(casType, "endTimeLimit", "us.feliscat.types.Time", featOkTst);
    casFeatCode_endTimeLimit  = (null == casFeat_endTimeLimit) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_endTimeLimit).getCode();

 
    casFeat_geographyLimit = jcas.getRequiredFeatureDE(casType, "geographyLimit", "us.feliscat.types.Geography", featOkTst);
