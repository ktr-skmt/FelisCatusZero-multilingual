...
public class KeywordExpansion_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.KeywordExpansion");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "us.feliscat.types.KeywordExpansion");
  ...
  public boolean getIsMandatory(int addr) {
      ...
      jcas.throwFeatMissing("isMandatory", "us.feliscat.types.KeywordExpansion");
