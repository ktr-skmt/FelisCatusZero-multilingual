...
public class BoWQuery_Type extends Query_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.BoWQuery");
  ...
  public int getIndriQuery(int addr) {
      ...
      jcas.throwFeatMissing("indriQuery", "us.feliscat.types.BoWQuery");
  ...
  public String getAlgorithm(int addr) {
      ...
      jcas.throwFeatMissing("algorithm", "us.feliscat.types.BoWQuery");
  ...
  public BoWQuery_Type(JCas jcas, Type casType) {
    ...
    casFeat_indriQuery = jcas.getRequiredFeatureDE(casType, "indriQuery", "us.feliscat.types.Keyword", featOkTst);
