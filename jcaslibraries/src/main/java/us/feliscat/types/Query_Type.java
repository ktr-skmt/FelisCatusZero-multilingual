...
public class Query_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Query");
  ...
  public boolean getAlreadyFinishedRetrieving(int addr) {
      ...
      jcas.throwFeatMissing("alreadyFinishedRetrieving", "us.feliscat.types.Query");
  ...
  public boolean getAlreadyFinishedCorrecting(int addr) {
      ...
      jcas.throwFeatMissing("alreadyFinishedCorrecting", "us.feliscat.types.Query");
  ...
  public int getKnowledgeSourceList(int addr) {
      ...
      jcas.throwFeatMissing("knowledgeSourceList", "us.feliscat.types.Query");
