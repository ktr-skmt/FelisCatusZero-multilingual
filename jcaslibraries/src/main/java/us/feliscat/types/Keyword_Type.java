...
public class Keyword_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Keyword");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "us.feliscat.types.Keyword");
  ...
  public int getExpansionSet(int addr) {
      ...
      jcas.throwFeatMissing("expansionSet", "us.feliscat.types.Keyword");
  ...
  public int getSentenceSet(int addr) {
      ...
      jcas.throwFeatMissing("sentenceSet", "us.feliscat.types.Keyword");
  ...
  public int getPassageSet(int addr) {
      ...
      jcas.throwFeatMissing("passageSet", "us.feliscat.types.Keyword");
  ...
  public int getDocumentSet(int addr) {
      ...
      jcas.throwFeatMissing("documentSet", "us.feliscat.types.Keyword");
  ...
  public boolean getIsMandatory(int addr) {
      ...
      jcas.throwFeatMissing("isMandatory", "us.feliscat.types.Keyword");
