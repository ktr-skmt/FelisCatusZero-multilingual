...
public class Exam_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.Exam");
  ...
  public int getQuestionSet(int addr) {
      ...
      jcas.throwFeatMissing("questionSet", "us.feliscat.types.Exam");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "us.feliscat.types.Exam");
  ...
  public String getDir(int addr) {
      ...
      jcas.throwFeatMissing("dir", "us.feliscat.types.Exam");
  ...
  public String getLang(int addr) {
      ...
      jcas.throwFeatMissing("lang", "us.feliscat.types.Exam");
