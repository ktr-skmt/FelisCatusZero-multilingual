...
public class CoreNLPAnalysis_Type extends Analysis_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.CoreNLPAnalysis");
  ...
  public int getTokenList(int addr) {
      ...
      jcas.throwFeatMissing("tokenList", "us.feliscat.types.CoreNLPAnalysis");
  ...
  public int getPartOfSpeechList(int addr) {
      ...
      jcas.throwFeatMissing("partOfSpeechList", "us.feliscat.types.CoreNLPAnalysis");
  ...
  public int getLemmaList(int addr) {
      ...
      jcas.throwFeatMissing("lemmaList", "us.feliscat.types.CoreNLPAnalysis");
  ...
  public int getStemmedWordList(int addr) {
      ...
      jcas.throwFeatMissing("stemmedWordList", "us.feliscat.types.CoreNLPAnalysis");
