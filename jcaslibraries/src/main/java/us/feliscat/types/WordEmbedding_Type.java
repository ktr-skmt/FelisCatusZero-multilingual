...
public class WordEmbedding_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("us.feliscat.types.WordEmbedding");
  ...
  public String getEmbeddingMethod(int addr) {
      ...
      jcas.throwFeatMissing("embeddingMethod", "us.feliscat.types.WordEmbedding");
  ...
  public int getVector(int addr) {
      ...
      jcas.throwFeatMissing("vector", "us.feliscat.types.WordEmbedding");
