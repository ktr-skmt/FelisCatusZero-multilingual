...
object Config {
  ...
  lazy val qaCorpusXmlSchema: String = config.as[Option[String]]("schema.qaCorpus").getOrElse("src/main/resources/schema/qa_corpus.xsd")
  lazy val qalabDatasetXmlSchema: String = config.as[Option[String]]("schema.qalabDataset").getOrElse("src/main/resources/schema/second_stage_exam.xsd")
  ...
  lazy val tokenLevelIndriSegmentationsInEnglish: Seq[String] =
    config.as[Option[Seq[String]]]("indri.segmentation.tokenLevel.textbook.en").getOrElse(Nil) ++
    config.as[Option[Seq[String]]]("indri.segmentation.tokenLevel.glossary.en").getOrElse(Nil)
  ...
  lazy val wordLevelIndriSegmentationsInEnglish: Seq[String] =
    config.as[Option[Seq[String]]]("indri.segmentation.wordLevel.textbook.en").getOrElse(Nil) ++
    config.as[Option[Seq[String]]]("indri.segmentation.wordLevel.glossary.en").getOrElse(Nil)
