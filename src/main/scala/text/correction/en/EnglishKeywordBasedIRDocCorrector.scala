...
import text.correction.MultiLingualKeywordBasedIRDocCorrector
...
/**
  ...
  * @author K.Sakamoto
  */
object EnglishKeywordBasedIRDocCorrector extends MultiLingualKeywordBasedIRDocCorrector with EnglishDocumentAnnotator {
