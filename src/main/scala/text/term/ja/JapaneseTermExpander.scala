...
import text.normalizer.ja.JapaneseWordExpressionNormalizer
import text.term.MultiLingualTermExpander
...
/**
  ...
  * @author K.Sakamoto
  */
object JapaneseTermExpander extends MultiLingualTermExpander with Japanese {
  private val expansions: Seq[Seq[String]] = {
    val map = mutable.Map.empty[String, ListBuffer[String]]
    JapaneseWordExpressionNormalizer.getTerms foreach {
      case (source, target) =>
